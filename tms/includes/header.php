	...
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			<li class="hm"><a href="index.php"><i class="fa fa-home"></i></a></li>
				<li class="hm"><a href="admin/index.php">Login Admin</a></li>
		</ul>
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Phone Number : 039.594.9986</li>				
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">LongLe <span>Tourist</span></a>	
		</div>
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="page.php?type=aboutus">Giới thiệu</a></li>
								<li><a href="package-list.php">Các tour</a></li>
								<li><a href="page.php?type=privacy">Tin tức</a></li>
								<li><a href="page.php?type=terms">Hướng dẫn</a></li>
